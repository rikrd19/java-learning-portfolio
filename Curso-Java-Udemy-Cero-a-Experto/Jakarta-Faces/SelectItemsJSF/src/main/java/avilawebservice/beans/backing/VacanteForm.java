...
import avilawebservice.beans.helper.ColoniaHelper;
...
public class VacanteForm {
    ...
    @Inject
    private Candidato candidato;  // attribute
    
    @Inject
    private ColoniaHelper coloniaHelper;  // attribute

    private boolean comentarioEnviado;  // attribute
