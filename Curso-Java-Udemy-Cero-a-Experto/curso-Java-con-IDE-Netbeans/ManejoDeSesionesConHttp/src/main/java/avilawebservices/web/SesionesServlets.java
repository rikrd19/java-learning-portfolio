...
@WebServlet(name = "SesionesServlets", urlPatterns = {"/SesionesServlets"})
public class SesionesServlets extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Si el usuario es nuevo o recurrente, obtenemos el objeto session
